...
class GeminiService
{
    ...
    public function generateRecommendation($subject, $description)
    {
        $prompt = "Bertindaklah sebagai mentor akademik. Saya mahasiswa yang kesulitan di mata kuliah: '$subject' dengan kendala: '$description'.\n\n"
            ...
            . "1. **Penjelasan Singkat**: Maksimal 3 paragraf pendek. Langsung ke inti permasalahan dan solusi praktis.\n"
            ...
            . "3. **Penulisan sumber belajar**: Sebelum sumber belajar diberikan, beri garis panjang dahulu untuk memisahkan antara penjelasan dan sumber belajar \n"
