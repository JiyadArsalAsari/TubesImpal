        ...
        <main class="max-w-4xl mx-auto px-6 py-10">
            ...
            <form action="{{ route('dosen.exercise.store', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data" class="bg-[#2f3d2c] border border-[#3c4c39] rounded-2xl p-6 shadow-xl space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" class="w-full rounded-lg bg-[#1f2f1f] text-white border border-[#436040] p-3 placeholder-gray-400" placeholder="Contoh: Quiz 1 - Introduction to UI/UX Design" required>
                </div>

                <div>
                    <label class="block text-sm text-gray-200 mb-1">Deskripsi (opsional)</label>
                    <textarea name="description" rows="3" class="w-full rounded-lg bg-[#1f2f1f] text-white border border-[#436040] p-3 placeholder-gray-400" placeholder="Ringkasan soal atau instruksi"></textarea>
                </div>
