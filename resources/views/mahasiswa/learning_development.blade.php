...
@push('styles')
    ...
    <style>
        /* Specific page overrides if any */
    </style>
@endpush

@section('content')
    <div class="flex-grow flex flex-col items-center w-full py-8">
                            ...
                            <div class="bg-[#2a3f2a] rounded-xl p-4 border border-gray-700">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($feedback->dosen)
                                            <span class="text-xs bg-gray-700 px-2 py-1 rounded text-gray-300">from
                                                {{ $feedback->dosen->nama }}</span>
                                        @endif
                                    </div>
